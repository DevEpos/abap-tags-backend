"! <p class="shorttext synchronized" lang="en">Helper for mapping CDS names to display names</p>
CLASS zcl_abaptags_cds_name_mapper DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_abaptags_cds_name_mapper IMPLEMENTATION.
