...
define view ZAbapTags_I_SubLvlObjWTag
  as select from    zabaptags_tgobjn   as ChildTgobj
    ...
    inner join      zabaptags_tags     as ChildTag
      on ChildTgobj.tag_id = ChildTag.tag_id

    left outer join ZAbapTags_I_TgObjn as GrandChildObj
      on  ChildTgobj.object_name = GrandChildObj.ParentObjectName
