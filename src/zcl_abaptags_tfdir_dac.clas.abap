"! <p class="shorttext synchronized" lang="en">DB Access for TFDIR</p>
CLASS zcl_abaptags_tfdir_dac DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      "! <p class="shorttext synchronized" lang="en">Finds function modules</p>
      find_func_modules
        IMPORTING
  ...
  PRIVATE SECTION.
    CLASS-DATA:
      instance TYPE REF TO zcl_abaptags_tfdir_dac.
ENDCLASS.
