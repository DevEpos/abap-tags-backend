"! <p class="shorttext synchronized">Resource for deleting Tagged Objects</p>
  ...
  METHOD post.
    ...
    IF object_ids_for_deletion IS INITIAL.
      RAISE EXCEPTION TYPE zcx_abaptags_adt_error
        EXPORTING textid = zcx_abaptags_adt_error=>no_tgobj_id_supplied.
    ENDIF.
